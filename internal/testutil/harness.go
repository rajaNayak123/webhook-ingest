...
// NewService builds an ingest.Service backed by the configured Postgres and
// Redis, for tests that need to exercise the service layer directly (e.g.
// Shutdown) rather than through HTTP.
